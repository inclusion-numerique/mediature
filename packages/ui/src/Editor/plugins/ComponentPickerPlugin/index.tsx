...
function ComponentPickerMenuItem({
  ...
  return (
    <>
      {/* eslint-disable-next-line jsx-a11y/no-noninteractive-element-interactions, jsx-a11y/no-noninteractive-element-to-interactive-role, jsx-a11y/click-events-have-key-events */}
      <li
        key={option.key}
        tabIndex={-1}
        className={className}
  ...
  const options = useMemo(() => {
    const baseOptions = [
      ...
      new ComponentPickerOption('Equation', {
        ...
        onSelect: () => showModal('Insert Equation', (onClose) => <InsertEquationDialog activeEditor={editor} onClose={onClose} />),
      }),
