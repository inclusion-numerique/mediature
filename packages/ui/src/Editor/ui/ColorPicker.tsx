...
export default function ColorPicker({ color, children, onChange, disabled = false, ...rest }: Readonly<ColorPickerProps>): JSX.Element {
      ...
      <div className="color-picker-wrapper" style={{ width: WIDTH }} ref={innerDivRef}>
        ...
        <div className="color-picker-basic-color">
          {basicColors.map((basicColor) => (
            <button
              aria-label="ouvrir le sélecteur de couleurs"
