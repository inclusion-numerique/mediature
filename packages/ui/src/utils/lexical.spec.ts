  ...
  describe('inlineEditorStateFromHtml()', () => {
    it('should pass by implicitly adding a parent to node root', async () => {
      const htmlContent = await fs.readFile(
        path.resolve(__dirname, '../../../../apps/main/src/fixtures/lexical/email-real-payload-list-issue.html'),
        'utf-8'
      );
    ...
    it('should pass by replacing empty tables', async () => {
      const htmlContent = await fs.readFile(
        path.resolve(__dirname, '../../../../apps/main/src/fixtures/lexical/email-real-payload-empty-table.html'),
        'utf-8'
      );
